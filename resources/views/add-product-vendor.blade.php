...
<body>
    ...
    <div class="container mt-5">
        <form action="/product-adding-vendor" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="exampleInputEmail0" name="added_by" readonly value="{{ $userName }}">
            </div>
            <div class="mb-3">
